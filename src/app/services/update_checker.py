...
from app.services.cache_utils import BoundedCache
...
# Bounded caches to prevent unbounded memory growth (PERF-004)
_CACHE_TTL = 60 * 60 * 6  # 6 hours
_html_cache: BoundedCache[str, str] = BoundedCache(
    max_size=100,
    ttl_seconds=_CACHE_TTL,
    name="html_cache",
)
_parsed_cache: BoundedCache[Tuple[str, str], Tuple[str, str, str]] = BoundedCache(
    max_size=200,
    ttl_seconds=_CACHE_TTL * 4,  # Parsed versions can be cached longer
    name="parsed_cache",
)
